...
export default function ColorSettings() {
    ...
    const [primaryColor, setPrimaryColor] = useState('background: #ffffff')
    ...
    const handleChangeComplete = (color) => {
        setPrimaryColor({ background: color.hex });
      };
    return (
        <div className={`colorSettings ${showSetting ? 'show' : ''}`}>
            <div className="colorSettings_toggler" onClick={showSettings}>
            ...
            <span className="colorSettings_Hide" onClick={showSettings}>
                 <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <BlockPicker color={ primaryColor }
